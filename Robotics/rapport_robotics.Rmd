...
# Modèle retenu
```{r}
boxplot(err.lin.mse, CV.noscale, err.las.mse, err.rid.mse, err.ela.mse, err.tree.mse, err.tree.mse.prune, err.randomForest.mse, err.svmlin.mse, err.svmlap.mse, err.svmgau.mse)
```
